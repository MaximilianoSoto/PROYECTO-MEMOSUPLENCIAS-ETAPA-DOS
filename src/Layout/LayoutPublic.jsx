...
<div className="flex  ">
    ...
    <div className=" w-full flex flex-col">
        ...
        <div className=" flex">
            <h1 className="text-5xl font-semibold text-center grid place-content-center text-white flex-grow">{headerTitle}</h1>
            <img src="src/assets/images/logo ministerio.png" className=" mr-3 w-36 "/>
        </div>
        </header>
